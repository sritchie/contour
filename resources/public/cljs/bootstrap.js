...
cljs.core.Range.prototype.cljs$core$ISeq$_rest = function(a) {
  return cljs.core.truth_(cljs.core._seq.call(null, a)) ? new cljs.core.Range(this.meta, cljs.core._PLUS_.call(null, this.start, this.step), this.end, this.step) : cljs.core.list.call(null)
};
...
cljs.core.Range.prototype.cljs$core$ICounted$_count = function(a) {
  return cljs.core.truth_(cljs.core.not.call(null, cljs.core._seq.call(null, a))) ? 0 : Math.ceil.call(null, cljs.core._SLASH_.call(null, cljs.core._.call(null, this.end, this.start), this.step))
};
...
clojure.browser.event.event_types = function event_types(b) {
  return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$event$EventType$event_types : b) ? b.clojure$browser$event$EventType$event_types(b) : function() {
    var c = event_types[goog.typeOf.call(null, b)];
    if(cljs.core.truth_(c)) {
      return c
    }else {
      if(c = event_types._, cljs.core.truth_(c)) {
        return c
      }else {
        throw cljs.core.missing_protocol.call(null, "EventType.event-types", b);
      }
    }
  }().call(null, b)
};
...
clojure.browser.net.connect = function() {
  var a = null, b = function(b) {
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$connect : b) ? b.clojure$browser$net$IConnection$connect(b) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
        if(c = a._, cljs.core.truth_(c)) {
          ...
          throw cljs.core.missing_protocol.call(null, "IConnection.connect", b);
        }
      }
    }().call(null, b)
  }, c = function(b, c) {
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$connect : b) ? b.clojure$browser$net$IConnection$connect(b, c) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
    ...
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$connect : b) ? b.clojure$browser$net$IConnection$connect(b, c, d) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
    ...
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$connect : b) ? b.clojure$browser$net$IConnection$connect(b, c, d, e) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
...
clojure.browser.net.transmit = function() {
  var a = null, b = function(b, c) {
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$transmit : b) ? b.clojure$browser$net$IConnection$transmit(b, c) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
        if(c = a._, cljs.core.truth_(c)) {
          ...
          throw cljs.core.missing_protocol.call(null, "IConnection.transmit", b);
        }
      }
    }().call(null, b, c)
  }, c = function(b, c, d) {
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$transmit : b) ? b.clojure$browser$net$IConnection$transmit(b, c, d) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
    ...
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$transmit : b) ? b.clojure$browser$net$IConnection$transmit(b, c, d, e) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
    ...
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$transmit : b) ? b.clojure$browser$net$IConnection$transmit(b, c, d, e, f) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
  ...
  }, f = function(b, c, d, e, f, l) {
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$transmit : b) ? b.clojure$browser$net$IConnection$transmit(b, c, d, e, f, l) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
    ...
    }().call(null, b, c, d, e, f, l)
  };
  return a = function(a, h, i, j, k, l) {
    switch(arguments.length) {
      case 2:
...
clojure.browser.net.close = function close(b) {
  return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$IConnection$close : b) ? b.clojure$browser$net$IConnection$close(b) : function() {
    var c = close[goog.typeOf.call(null, b)];
    if(cljs.core.truth_(c)) {
      return c
    }else {
      if(c = close._, cljs.core.truth_(c)) {
        return c
      }else {
        throw cljs.core.missing_protocol.call(null, "IConnection.close", b);
      }
    }
  }().call(null, b)
};
...
clojure.browser.net.register_service = function() {
  var a = null, b = function(b, c, f) {
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$ICrossPageChannel$register_service : b) ? b.clojure$browser$net$ICrossPageChannel$register_service(b, c, f) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
        if(c = a._, cljs.core.truth_(c)) {
          ...
          throw cljs.core.missing_protocol.call(null, "ICrossPageChannel.register-service", b);
        }
      }
    }().call(null, b, c, f)
  }, c = function(b, c, f, g) {
    return cljs.core.truth_(cljs.core.truth_(b) ? b.clojure$browser$net$ICrossPageChannel$register_service : b) ? b.clojure$browser$net$ICrossPageChannel$register_service(b, c, f, g) : function() {
      var c = a[goog.typeOf.call(null, b)];
      if(cljs.core.truth_(c)) {
        return c
      }else {
...
contour.mapview.map_load = function() {
  return contour.mapview._STAR_map_STAR_ = contour.mapview.init_map.call(null, goog.dom.getElement.call(null, "map_canvas"), cljs.core.Vector.fromArray([contour.mapview.mk_overlay.call(null, "species-range", contour.mapview.species_range_tile_url, 1), contour.mapview.mk_overlay.call(null, "forma", contour.mapview.forma_tile_url, 1), contour.mapview.mk_overlay.call(null, "iucn", contour.mapview.iucn_tile_url, 0.5), contour.mapview.mk_overlay.call(null, "cell-towers", contour.mapview.cell_towers_tile_url, 
  1)]))
};
