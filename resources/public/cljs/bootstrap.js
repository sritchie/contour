...
contour.mapview.carto_tiler_fn = function(a) {
  if(!cljs.core.truth_(cljs.core.not_EQ_.call(null, "/", cljs.core.last.call(null, a)))) {
    throw Error(cljs.core.str.call(null, "Assert failed: ", cljs.core.pr_str.call(null, cljs.core.list("\ufdd1'not=", "/", cljs.core.list("\ufdd1'last", "\ufdd1'root")))));
  }
  return function(b, c) {
...
contour.mapview.forma_tile_url = function(a, b) {
  var c = Math.pow.call(null, 2, b) - 1;
  return cljs.core.str.call(null, contour.util.pathify.call(null, contour.mapview.forma_root, b, Math.abs.call(null, a.x), c - a.y), ".png")
};
...
contour.mapview.init_map = function(a, b) {
  var c = contour.util.clj__GT_js.call(null, contour.mapview.map_opts), c = new google.maps.Map(a, c), d = cljs.core.seq.call(null, b);
  if(cljs.core.truth_(d)) {
    for(var e = cljs.core.first.call(null, d);;) {
      if(c.overlayMapTypes.push(e), e = cljs.core.next.call(null, d), cljs.core.truth_(e)) {
