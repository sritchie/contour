...
contour.mapview.cell_towers_tile_url = function(a, b) {
  return cljs.core.str.call(null, contour.mapview.cell_towers_root, b, "/", a.x, "/", a.y, ".png")
};
contour.mapview.species_range_tile_url = function(a, b) {
  return cljs.core.str.call(null, contour.mapview.species_range_root, b, "/", a.x, "/", a.y, ".png")
};
contour.mapview.forma_tile_url = function(a, b) {
  var c = Math.pow.call(null, 2, b);
  return cljs.core.str.call(null, contour.mapview.forma_root, b, "/", Math.abs.call(null, a.x), "/", c - a.y - 1, ".png")
};
